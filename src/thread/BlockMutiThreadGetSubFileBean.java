...
public class BlockMutiThreadGetSubFileBean extends Thread {
	...
	public BlockMutiThreadGetSubFileBean(String outputdir ) {
		super();
		outdir=outputdir;
	}
	public void run()
...
//			}
	...
	public boolean moveFile(File f)
	{
		...
		if(f.exists())
		{
				 ...
				 if(targetFile1.exists()) targetFile1.delete();
	...
	public static  void  main(String args[]) throws Throwable
	{
		...
		for(int i=0;i<3;i++)
		{
			BlockMutiThreadGetSubFileBean onethread=new BlockMutiThreadGetSubFileBean(outdir);
			onethread.start();
		}
	}
