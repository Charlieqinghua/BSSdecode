...
public class ZXSCDRMutiThreadGetSubFileBean extends Thread {
	...
	public ZXSCDRMutiThreadGetSubFileBean(String outputdir ) {
		super();
		outdir=outputdir;
	}
	//使用工厂动态创建后需要修改构造函数
	public ZXSCDRMutiThreadGetSubFileBean() {
		super();
	}
	...
	public static  void  main(String args[]) throws Throwable
	{
		...
		for(int i=0;i<3;i++)
		{
			ZXSCDRMutiThreadGetSubFileBean onethread=new ZXSCDRMutiThreadGetSubFileBean(outdir);
			onethread.start();
		}
	}
