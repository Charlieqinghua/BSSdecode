...
import templateBean.scdr.SCDRPaseDecodeBean;
import templateBean.scdr.SCDRPaseDecodeBeanDebug;
...
/*
 * 供魏进武使用的人口信息跟踪的系统 scdr的
 * 
 * */
public class SCDRDemoThreadFileBean extends Thread {
	...
	TmplatePaseDecodeBean scdrdecode=new SCDRPaseDecodeBean(RowBeanlist,afdecode);
	//FileOutResultAllFieldBean out=new FileOutResultAllFieldBeanGz(DicTion.scdrhead);
	FileOutResultAllFieldBean out=new FileOutResultAllFieldBeanGz(Area.clound);
	String outdir=DicTion.outdir;
		
	public SCDRDemoThreadFileBean(String outputdir ) {
		super();
		outdir=outputdir;
	}
	//使用工厂动态创建后需要修改构造函数
	public SCDRDemoThreadFileBean() {
		super();
	}
...
//			}
	...
	public static  void  main(String args[]) throws Throwable
	{
		...
		for(int i=0;i<3;i++)
		{
			SCDRDemoThreadFileBean onethread=new SCDRDemoThreadFileBean(outdir);
			onethread.start();
		}
	}
