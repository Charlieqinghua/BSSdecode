 ...
 * @category
 * 
 * scdr 的解码类继承自TmplatePaseDecode,其所有输出都是全字段自动换行输出
 * 
 *
 */
public class ScdrPaseDecodeAllField extends TmplatePaseDecode {
	//TrafficDataDecode afdecode=new TrafficDataDecode();
	TrafficDataDecode afdecode;
	public ScdrPaseDecodeAllField(TrafficDataDecode afdecode) {
		super();
		this.afdecode = afdecode;
	}
	public ScdrPaseDecodeAllField() {
		super();
