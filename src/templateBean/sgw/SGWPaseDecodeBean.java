 ...
 * @param args
 */
public class SGWPaseDecodeBean extends templateBean.TmplatePaseDecodeBean {
	String startflag="0xbf4e";
	String trafficflag="0xac";//内嵌上下行流量的标签
	public SGWPaseDecodeBean(List<RowBean> rowBeanlist,
	...
	public int dealTLV(int starttag,int pos,int way,int arrnum)//处理完 tlv 返回 最后的位置
	{
		...
		if(taglen<0) 
		{
			...
			else if(taglen==b83)//0x83018a后面两个是长度
			{
...
//					rowbean.add(word,arrnum);
	...
	public static void main(String[] args) {
		...
		TmplatePaseDecodeBean pase=new SGWPaseDecodeBean(RowBeanlist,afdecode);
